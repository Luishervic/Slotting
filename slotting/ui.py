...
def estado_flujo() -> dict[str, bool]:
    ...
    return {
        ...
        "operacion": (st.session_state.get("comparativa_metodos") is not None
                      or st.session_state.get("ultima_simulacion") is not None),
    ...
    with st.sidebar:
        ...
        for clave, destino, etiqueta, icono in pasos:
            bloqueado = (
                ...
                or (clave == "operacion" and not estado["diseno"])
            )
